        ...
        if (_productController.isLoading.value)
          ...
          return ListView.builder(
              ...
              itemBuilder: (_, index) {
                return Column(
                  children: [
                    Row(children: [Container(width: 150, height: 150, margin: EdgeInsets.fromLTRB(16, 8, 8, 8),
                      child: ClipRRect(
                        borderRadius: BorderRadius.circular(8),
                        child: Image.network(_productController.productList[index].imageLink, width: 150,
                          height: 100,
                          fit: BoxFit.fill,
                          color: Colors.purple,
